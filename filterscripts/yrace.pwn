...
#define MAX_RACECHECKPOINTS 50 // Change if you want more room for checkpoints than this
#define MAX_BUILDERS 5 // Change if you want more builderslots than this
...
new RRotationDelay = 900000; // How often will we poll for new race start if RRotation is enabled? (Default: 15 minutes, can't be changed IG)
...
new PrizeMode=4;        //Mode for winnings: 0 - Fixed, 1 - Dynamic, 2 - Entry fee, 3 - EF+F, 4 EF+D [Admin menu ingame]
...
public OnPlayerCommandText(playerid, cmdtext[])
{
	if(player[playerid][spawned] == 0)
	{
		...
		else return SendClientMessage(playerid, COLOR_GREEN, "You must spawn first! 1");
	}
...
dcmd_racehelp(playerid, params[])
{
	...
	format(logstring, sizeof(logstring),"%s issues command /racehelp", aplayername);
...
dcmd_buildhelp(playerid, params[])
{
    #pragma unused params
   	...
   	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /buildhelp", aplayername);
	printlog("CMD-F", logstring);
...
dcmd_buildrace(playerid, params[])
{
    #pragma unused params
   	...
   	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /buildrace", aplayername);
	printlog("CMD-F", logstring);
    
	if(BuildAdmin == 1 && !IsVIP(playerid))
	return SendClientMessage(playerid, COLOR_RED, "You must be a VIP for this command");
...
dcmd_cp(playerid, params[])
{
	...
	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /cp", aplayername);
	printlog("CMD-F", logstring);
...
dcmd_scp(playerid, params[])
{
    ...
    GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /scp %s", aplayername);
	printlog("CMD-F", logstring);
...
dcmd_rcp(playerid, params[])
{
	...
	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /rcp", aplayername);
	printlog("CMD-F", logstring);
...
dcmd_mcp(playerid, params[])
{
	...
	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /mcp %s", aplayername, params);
	printlog("CMD-F", logstring);
...
dcmd_dcp(playerid, params[])
{
	...
	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /dcp", aplayername);
	printlog("CMD-F", logstring);
...
dcmd_clearrace(playerid,params[])
{
	...
	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /clearrace", aplayername);
	printlog("CMD-F", logstring);
...
dcmd_editrace(playerid,params[])
{
	...
	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /editrace %s", aplayername, params);
	printlog("CMD-F", logstring);
	...
	format(race_name,sizeof(race_name), "Races/%s.yr",tmp);
	if(!fexist(race_name))
	{
...
dcmd_saverace(playerid, params[])
{
	if(RaceBuilders[playerid] != 0)
	{
	    ...
	    GetPlayerName(playerid, aplayername, sizeof(aplayername));
		format(logstring, sizeof(logstring),"%s issues command /saverace %s", aplayername, params);
		printlog("CMD-F", logstring);
		...
		new race_name[32],templine[42];
		format(race_name, 32, "Races/%s.yr",tmp);
		if(fexist(race_name))
		{
...
dcmd_setlaps(playerid,params[])
{
    ...
    if(!strlen(tmp) || strval(tmp) <= 0)
	{
   	...
   	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /setlaps %s", aplayername, params);
	printlog("CMD-F", logstring);
...
dcmd_racemode(playerid,params[])
{
	...
	if (0 > tempmode || tempmode > 3)
   	...
   	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /racemode %s", aplayername, params);
	printlog("CMD-F", logstring);
...
dcmd_loadrace(playerid, params[])
{
    ...
    GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /loadrace %s", aplayername, params);
	printlog("CMD-F", logstring);
...
dcmd_startrace(playerid, params[])
{
	...
	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /startrace", aplayername);
	printlog("CMD-F", logstring);
...
{
	if((RaceAdmin == 1 || BuildAdmin == 1) && !IsAdmin(playerid))
	return SendClientMessage(playerid, COLOR_RED, "You must be an admin for this command");
	...
	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /deleterace %s", aplayername, params);
	printlog("CMD-F", logstring);
	
	format(filename,sizeof(filename),"Races/%s.yr",filename);
	if(!fexist(filename))
	{
...
dcmd_join(playerid,params[])
{
	...
	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /join", aplayername);
	printlog("CMD-F", logstring);
	...
	else if(RaceActive==1 && RaceStart==0)
	{
		...
		if (CurrentCheckpoint[playerid] == 0)
		{
		  	if (IsPlayerInAnyVehicle(playerid))
			{
				...
				SetVehiclePos(vID, RaceCheckpoints[0][0],RaceCheckpoints[0][1],RaceCheckpoints[0][2]+1);
			} else SetPlayerPos(playerid, RaceCheckpoints[0][0],RaceCheckpoints[0][1],RaceCheckpoints[0][2]+1);
		}
...
dcmd_leave(playerid,params[])
{
	...
	if(RaceParticipant[playerid] > 0)
	{
		...
		GetPlayerName(playerid, aplayername, sizeof(aplayername));
		format(logstring, sizeof(logstring),"%s issues command /leave", aplayername);
		printlog("CMD-F", logstring);
...
dcmd_endrace(playerid, params[])
{
    ...
    GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /endrace", aplayername);
	printlog("CMD-F", logstring);
...
dcmd_ready(playerid, params[])
{
	...
	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /ready", aplayername);
	printlog("CMD-F", logstring);
...
dcmd_bestlap(playerid,params[])
{
	...
	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /bestlap %s", aplayername, params);
	printlog("CMD-F", logstring);
...
dcmd_bestrace(playerid,params[])
{
    ...
    GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /bestrace %s", aplayername, params);
	printlog("CMD-F", logstring);
...
dcmd_airrace(playerid,params[])
{
	...
	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /airrace", aplayername);
	printlog("CMD-F", logstring);
...
dcmd_cpsize(playerid,params[])
{
	...
	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /cpsize %s", aplayername, params);
	printlog("CMD-F", logstring);
...
dcmd_prizemode(playerid,params[])
{
    ...
    GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /prizemode %s", aplayername, params);
	printlog("CMD-F", logstring);
...
dcmd_setprize(playerid,params[])
{
	...
	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /setprize %s", aplayername, params);
	printlog("CMD-F", logstring);
...
dcmd_raceadmin(playerid,params[])
{
	...
	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /raceadmin", aplayername);
	printlog("CMD-F", logstring);
...
dcmd_buildmenu(playerid,params[])
{
	...
	GetPlayerName(playerid, aplayername, sizeof(aplayername));
	format(logstring, sizeof(logstring),"%s issues command /buildmenu", aplayername);
	printlog("CMD-F", logstring);
...
{
	new temprace[67], idx;
	format(temprace,sizeof(temprace),"Races/%s.yr",tmp);
    if(strlen(tmp))
    {
		if(!fexist(temprace))
		{
...
public RaceRotation()
{
	if(!fexist("Races/yrace.race"))
	{
	    printf("ERROR in  YRACE's Race Rotation (yrace.race): yrace.race doesn't exist!");
	    return -1;
	}
	...
	new File:f, templine[32], rotfile[]="Races/yrace.race", rraces=-1, rracenames[32][32], idx, fback;
	...
	if(fback == -1) printf("ERROR in YRACE's Race Rotation (yrace.race): Race \'%s\' doesn't exist!",rracenames[RRotation]);
	else if (fback == -2) printf("ERROR in YRACE's Race Rotation (yrace.race): Race \'%s\' is created with a newer version of YRACE",rracenames[RRotation]);
	else startrace();
	return 1;
}
